...
<body>
	...
	<div class="konten">
		...
		<form action="<?php echo site_url('Event_cntr/editdata');?>" method="post">
			<div class="Container">
			    <div class="row1">
					<div class="col-md-4">
						ID_Event
					...
					<div class="col-md-8">
						<input type="text" name="id_event" value="<?php echo $row->id_event ?>" style="width: 500px;" >
					</div>
				</div>
				<br><br><div class="row1">
					...
					<div class="col-md-8">
						<input type="text" name="npm" value="<?php echo $this->session->userdata('npm');?>" style="width: 500px;" readonly>
					</div>
				</div>
				<br><br> 	
				<div class="row1">
					...
					<div class="col-md-8">
						<input type="text" name="judul" value="<?php echo $row->judul_event;?>" style="width: 500px;">
					</div>
				</div>
				<br><br>
				<div class="row1">
				...
				<div class="row1">
					...
					<div class="col-md-8">
						<textarea name="desk" style="width:250px;height:100px;" value="<?php echo $row->Deskripsi_event;?>"></textarea>
					</div>
				</div>	
				<br><br>
				<div class="row1">
					...
					<div class="col-md-8">
						<input type="text" name="harga" value="<?php echo $row->harga;?>" style="width: 500px;">
					</div>
				</div>
				<br><br>
				<div class="row1">
					...
					<div class="col-md-8">
						<input type="text" name="stok" value="<?php echo $row->stok;?>" style="width: 500px;">
					</div>
				</div>
				<br><br>
				<div class="row1">
					...
					<div class="col-md-8">
						<input type="text" name="Rekening" value="<?php echo $row->no_rek;?>" style="width: 500px;">
					</div>
				</div>
				<br><br>
				<div class="row1">
					...
					<div class="col-md-8">
						<input type="file" name="image" id="image_event" style="border:none; top: 50px;">
					</div>
				</div>
